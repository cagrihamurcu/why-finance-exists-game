...
with c1:
    if st.button("🧹 Oyunu Sıfırla"):
        ...
        st.rerun()
with c2:
    st.caption("Süre yok: ekran stabil ve akış net.")
...
if st.button(btn_label):
    ...
    infl = float(CFG["INFLATION_M"])
    inflation_loss = float(p["holdings"]["cash"]) * infl
    p["holdings"]["cash"] *= (1.0 - infl)
