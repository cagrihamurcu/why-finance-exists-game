...
CFG = {
    ...
    # Sayfa yenileme aralığı (sn) - paket yoksa timer için
    "REFRESH_SEC": 1.0,
}
...
# Süre dolduysa kararları sıfırla
if time_up:
    alloc = {}
    alloc_sum = 0.0
    repay_pct = 0
...
# =========================
# CANLI TIMER - EN SONDA!
# (Aksi halde sayfa aşağıya inmeden rerun olur)
# =========================
if (not p.get("finished", False)) and (left > 0):
